    ...
    useEffect(() => {
        const checkUserCount = async () => {
            try {
                ...
                // User count check failed, registration availability unknown
            }
        };
        checkUserCount();
    }, []);
        ...
        <div className="min-h-screen flex bg-slate-50 dark:bg-gray-900 transition-colors duration-200">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-blue-600 dark:bg-blue-800 relative overflow-hidden flex-col justify-center items-center text-white p-12">
                ...
                <div className="relative z-10 text-center">
                    ...
                    <h1 className="text-5xl font-bold mb-4 tracking-tight">CDRRMO</h1>
                    <p className="text-xl text-blue-100 max-w-md mx-auto font-light">
                        Secure, efficient, and reliable file management for disaster risk reduction.
                    </p>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12">
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="mt-2 text-slate-600 dark:text-gray-400">Please sign in to your account</p>
                    </div>
